...
var app1 = {
  ...
  bindEvent: function bindEvent() {
    ...
    var _loop = function _loop(selector) {
      (0, _jquery.default)(selector).click(function () {
    ...
    for (var selector in evts) {
      _loop(selector);
    }
  },
  render: function render() {
    (0, _jquery.default)("#output").text(this.n);
  },
  add1: function add1() {
    this.n += 1;
  },
...
var app2 = {
  ...
  render: function render() {
    var i = app2.tabIndex;
    (0, _jquery.default)(".tab").eq(i).addClass("selected").siblings().removeClass("selected");
    (0, _jquery.default)(".content").eq(i).addClass("active").siblings().removeClass("active");
    localStorage.setItem("app2.tabIndex", i);
  },
  bindEvent: function bindEvent() {
    (0, _jquery.default)(".tab-wrap").on("click", ".tab", function (e) {
      app2.tabIndex = (0, _jquery.default)(e.currentTarget).attr("data-index");
      app2.render();
    });
  }
};
...
var app3 = {
  ...
  bindEvent: function bindEvent() {
    (0, _jquery.default)(".square").on("click", function (e) {
...
var app4 = {
  ...
  render: function render() {
    (0, _jquery.default)(".circle").on("click", function (e) {
      (0, _jquery.default)(this).toggleClass("active");
    });
  }
};
...
_app4.default.init();
},{"./style.css":"style.css","./app1.js":"app1.js","./app2.js":"app2.js","./app3.js":"app3.js","./app4.js":"app4.js"}],"../../../../AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
